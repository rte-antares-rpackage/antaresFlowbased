...
Initialisation of study is done by the function *initFlowBased ()*. This result by the write of the following 4 files in the folder */user/flowbased* as well as the temporary modification of the project configuration :
