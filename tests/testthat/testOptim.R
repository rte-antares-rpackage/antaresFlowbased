...
PTDF <- system.file("test/data/optim/PTDF.csv",package = "antaresFlowbased")
PTDF <- fread(PTDF)

face <- system.file("test/data/optim/B.csv",package = "antaresFlowbased")
face <- fread(face)

resultsAMPL <- system.file("test/data/optim/AMPLobjective.csv",package = "antaresFlowbased")
